...
def links() -> rx.components:
    return rx.hstack(
        link_icon(
            icon= '/icons/white/social/instagram.svg',
            alt= 'Icono de Instagram',
            href= DAI_INSTAGRAM_URL
        ),
        link_icon(
            icon= '/icons/white/social/x.svg',
            alt= 'Icono de Twitter / X',
            href= DAI_TWITTER_URL
        ),
        link_icon(
            icon= '/icons/white/social/email.svg',
            alt= 'Icono de email',
            href= DAI_MAIL_URL
        ),
        link_icon(
            icon= '/icons/white/social/whatsapp.svg',
            alt= 'Icono de whatsapp',
            href= DAI_WHATSAPP_URL
        ),
        link_icon(
            icon= '/icons/white/social/web.svg',
            alt= 'Icono de web',
            href= DAI_WEB_URL
        )
    )